...
namespace ngla
{
  ...
  */
  class DLL_HEADER BaseBlockJacobiPrecond : virtual public BaseMatrix
  {
  public:
  ...
  */
  ...
  class  DLL_HEADER BlockJacobiPrecond : virtual public BaseBlockJacobiPrecond,
  ...
  class NGS_DLL_HEADER BlockJacobiPrecondSymmetric : 
