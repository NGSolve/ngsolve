...
if(EXISTS ${MUMPS_DIR}/include/mumps_compat.h)
    ...
    find_library(LIB_SCALAPACK scalapack)
    set(LIB_GFORTRAN gfortran)
    find_library(LIB_MPIF90 mpif90)
    set(MUMPS_LIBRARIES "${LIB_MUMPS_D};${LIB_MUMPS_Z};${LIB_MUMPS_COMMON};${LIB_MUMPS_PORD};${LIB_METIS};${LIB_GFORTRAN};${LIB_MPIF90};${LIB_SCALAPACK}")
