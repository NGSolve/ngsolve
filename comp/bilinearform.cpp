...
namespace ngcomp
{
  ...
  */
  ...
  void BilinearForm :: Assemble (LocalHeap & lh)
  {
    ...
    if (matrix_free_bdb || nonlinear_matrix_free_bdb || matfree_opts)
      {
  ...
  {
    if (nonlinear_matrix_free_bdb || matrix_free_bdb || matfree_opts)
      {
  ...
  */
  ...
  RegisterClassForArchive<MatFreeOptions> regmfopt;
}
