...
namespace ngcomp
{
  ...
  typedef size_t index_edge;
    ...
    class HDivCurlFESpace : public FESpace
  {
    size_t ndof;
  ...
  public:
    HDivCurlFESpace (shared_ptr<MeshAccess> ama, const Flags & flags, bool checkflags=false);

    virtual string GetClassName () const override
    {
      return "HDivCurlFESpace";
    }
