...
% \begin{itemize}
% {\em File netgen/Makefile:} \\
% Make sure that the line 
% \begin{verbatim}
% appngs =  lib/$(MACHINE)/*.o -lngsolvebasic
% \end{verbatim}
% $
% is commented in (currently line 63). This will link the
% necessary object and library files.
%
...
% \end{verbatim}
%
%to compile the NGSolve package.
%
% \begin{itemize}
% \item
% {\em File netgen/ngtcl/ngappinit:} 
% Make sure that 
% \begin{verbatim}
% #define NGSOLVE
% \end{verbatim}
% is commented in (currently line 232). 
% 
% \end{itemize}
