...
{
  ConstEBEKernelCopyInIdxKernel<<<512,256>>> (numblocks, idx, bs, row_dnums, dev_ux, dev_hx);
}
...
{
  ConstEBEKernelCopyOutIdxKernel<<<512,256>>> (numblocks, idx, bs, col_dnums, dev_hy, dev_uy);
}
