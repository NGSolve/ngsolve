...
xcopy "%PROJ_DIR%..\*.pde" "%INSTALL_FOLDER%\my_little_ngsolve\*.pde" /i /d /y
xcopy "%PROJ_DIR%..\*.vol" "%INSTALL_FOLDER%\my_little_ngsolve\*.vol" /i /d /y
xcopy "%PROJ_DIR%..\*.in2d" "%INSTALL_FOLDER%\my_little_ngsolve\*.in2d" /i /d /y
xcopy "%PROJ_DIR%..\*.vol.*" "%INSTALL_FOLDER%\my_little_ngsolve\*.vol.*" /i /d /y

xcopy "%PROJ_DIR%..\mixed\*.pde" "%INSTALL_FOLDER%\my_little_ngsolve\mixed\*.pde" /i /d /y
xcopy "%PROJ_DIR%..\mixed\*.vol" "%INSTALL_FOLDER%\my_little_ngsolve\mixed\*.vol" /i /d /y
xcopy "%PROJ_DIR%..\mixed\*.in2d" "%INSTALL_FOLDER%\my_little_ngsolve\mixed\*.in2d" /i /d /y
xcopy "%PROJ_DIR%..\mixed\*.vol.*" "%INSTALL_FOLDER%\my_little_ngsolve\mixed\*.vol.*" /i /d /y

xcopy "%PROJ_DIR%..\precond\*.pde" "%INSTALL_FOLDER%\my_little_ngsolve\precond\*.pde" /i /d /y
xcopy "%PROJ_DIR%..\precond\*.vol" "%INSTALL_FOLDER%\my_little_ngsolve\precond\*.vol" /i /d /y
xcopy "%PROJ_DIR%..\precond\*.in2d" "%INSTALL_FOLDER%\my_little_ngsolve\precond\*.in2d" /i /d /y
xcopy "%PROJ_DIR%..\precond\*.vol.*" "%INSTALL_FOLDER%\my_little_ngsolve\precond\*.vol.*" /i /d /y

xcopy "%PROJ_DIR%..\tcl\*.pde" "%INSTALL_FOLDER%\my_little_ngsolve\tcl\*.pde" /i /d /y
xcopy "%PROJ_DIR%..\tcl\*.vol" "%INSTALL_FOLDER%\my_little_ngsolve\tcl\*.vol" /i /d /y
xcopy "%PROJ_DIR%..\tcl\*.in2d" "%INSTALL_FOLDER%\my_little_ngsolve\tcl\*.in2d" /i /d /y
xcopy "%PROJ_DIR%..\tcl\*.vol.*" "%INSTALL_FOLDER%\my_little_ngsolve\tcl\*.vol.*" /i /d /y

echo %PROJ_NAME%
if /i "%PROJ_NAME%" == "libtcldemo" (
xcopy "%PROJ_DIR%..\tcl\*.tcl" "%INSTALL_FOLDER%\bin\*.tcl" /i /d /y
)
