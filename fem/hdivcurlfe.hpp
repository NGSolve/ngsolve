...
namespace ngfem
{
  ...
  template <int DIM>
  class HDivCurlFiniteElement : public FiniteElement
  {
  public:
  ...
  template <ELEMENT_TYPE ET> class HDivCurlFE;

  
  template <ELEMENT_TYPE ET>
  class T_HDivCurlFE : public HDivCurlFiniteElement<ET_trait<ET>::DIM>,
  ...
  protected:
    ...
    using HDivCurlFiniteElement<ET_trait<ET>::DIM>::ndof;
    using HDivCurlFiniteElement<ET_trait<ET>::DIM>::order;
  ...
  public:
    ...
    T_HDivCurlFE (int aorder, bool _plus = false)
      : plus(_plus)
    {
      order = aorder;
    ...
    const HDivCurlFE<ET> * Cast() const { return static_cast<const HDivCurlFE<ET>*> (this); } 
    ...
    {
      cout << "Error, T_HDivCurlFE<ET>:: ComputeNDof not available, only for ET == TRIG" << endl;
    }
  ...
  template <ELEMENT_TYPE ET> class HDivCurlFE : public T_HDivCurlFE<ET> 
  {
  protected:
    using T_HDivCurlFE<ET> :: order;
    using T_HDivCurlFE<ET> :: ndof;
  public:
  ...
  template <> class HDivCurlFE<ET_TRIG> : public T_HDivCurlFE<ET_TRIG> 
  {
    
  public:
    using T_HDivCurlFE<ET_TRIG> :: T_HDivCurlFE;
  ...
  template <> class HDivCurlFE<ET_QUAD> : public T_HDivCurlFE<ET_QUAD> 
  {
    
  public:
    using T_HDivCurlFE<ET_QUAD> :: T_HDivCurlFE;
  ...
  template <> class HDivCurlFE<ET_PRISM> : public T_HDivCurlFE<ET_PRISM> 
  {
  public:
    ...
    using T_HDivCurlFE<ET_PRISM> :: T_HDivCurlFE;
  ...
  template <> class HDivCurlFE<ET_TET> : public T_HDivCurlFE<ET_TET> 
  {
  public:
    using T_HDivCurlFE<ET_TET> :: T_HDivCurlFE;
  ...
  template <> class HDivCurlFE<ET_HEX> : public T_HDivCurlFE<ET_HEX> 
  {
  public:
    using T_HDivCurlFE<ET_HEX> :: T_HDivCurlFE;
  ...
  ////////////////////// SURFACE ////////////////////////////
    template <int DIM>
  class HDivCurlSurfaceFiniteElement : public FiniteElement
  {
  public:
    using FiniteElement::FiniteElement;
    using FiniteElement::ndof;
  ...
  template <ELEMENT_TYPE ET> class HDivCurlSurfaceFE;

  
  template <ELEMENT_TYPE ET>
  class T_HDivCurlSurfaceFE : public HDivCurlSurfaceFiniteElement<ET_trait<ET>::DIM>,
    public VertexOrientedFE<ET>
  {
  protected:
    enum { DIM = ET_trait<ET>::DIM };
    ...
    using VertexOrientedFE<ET>::vnums;
    using HDivCurlSurfaceFiniteElement<ET_trait<ET>::DIM>::ndof;
    using HDivCurlSurfaceFiniteElement<ET_trait<ET>::DIM>::order;
  ...
  public:
    ...
    T_HDivCurlSurfaceFE (int aorder)
    {
      order = aorder;
      order_inner = aorder;
    }
    ...
    virtual ELEMENT_TYPE ElementType() const { return ET; }
    const HDivCurlSurfaceFE<ET> * Cast() const { return static_cast<const HDivCurlSurfaceFE<ET>*> (this); } 
    
    INLINE void SetOrderInner (INT<DIM,int> order) { order_inner = order; }

    virtual void ComputeNDof()
    {
      cout << "Error, T_HDivCurlSurfaceFE<ET>:: ComputeNDof not available for base class" << endl;
    }
  ...
  template <> class HDivCurlSurfaceFE<ET_SEGM> : public T_HDivCurlSurfaceFE<ET_SEGM> 
  {
    
  public:
    using T_HDivCurlSurfaceFE<ET_SEGM> :: T_HDivCurlSurfaceFE;
  ...
  template <> class HDivCurlSurfaceFE<ET_TRIG> : public T_HDivCurlSurfaceFE<ET_TRIG> 
  {
    
  public:
    using T_HDivCurlSurfaceFE<ET_TRIG> :: T_HDivCurlSurfaceFE;

    virtual void ComputeNDof()
    {
      order = 0;
      ndof = 0;
      ndof += (order_inner[0]+1+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd)*(order_inner[0]+2+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd)/2;
      order = max2(order, order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd);
    }
    ...
    void T_CalcShape (TIP<2,Tx> ip, TFA & shape) const
    {
      ...
      ArrayMem<AutoDiff<3>,20> leg_u(order_inner[0]+2), leg_v(order_inner[0]+3);
        ...
        leg_u.SetSize(order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd+1);
        leg_v.SetSize(order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd+1);
        ScaledLegendrePolynomial(order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd,lx[fav[0]]-lx[fav[1]],lx[fav[0]]+lx[fav[1]],leg_u);
        LegendrePolynomial::Eval(order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd,2 * lx[fav[2]] - 1,leg_v);

        for(int j = 0; j <= order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd; j++)
          for(int k = 0; k <= order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_zz1_bd-j; k++)
            shape[ii++] = Prism_Dl1xDl3_symtensor_Dl2xDl4_u(lx[fav[0]], lx[fav[1]], lx[fav[2]], lx[fav[2]], leg_u[j]*leg_v[k]);
      }
  };


    template <> class HDivCurlSurfaceFE<ET_QUAD> : public T_HDivCurlSurfaceFE<ET_QUAD> 
  {
    
  public:
    using T_HDivCurlSurfaceFE<ET_QUAD> :: T_HDivCurlSurfaceFE;

    virtual void ComputeNDof()
    {
      order = 0;
      ndof = 0;
      ndof += (order_inner[0]+1+HDivCurlFE<ET_PRISM>::incrorder_xx1_bd)*(order_inner[1]+1+HDivCurlFE<ET_PRISM>::incrorder_xx2_bd);
      order = max2(order, order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_xx1_bd);
      order = max2(order, order_inner[1]+HDivCurlFE<ET_PRISM>::incrorder_xx2_bd);
    }
    ...
    void T_CalcShape (TIP<2,Tx> ip, TFA & shape) const
    {
      ...
      for(int k = 0; k <= order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_xx2_bd; k++)
        for(int l = 0; l <= order_inner[0]+HDivCurlFE<ET_PRISM>::incrorder_xx1_bd; l++)
        {
